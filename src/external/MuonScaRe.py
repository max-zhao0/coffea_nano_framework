"""
Module providing muon momentum scale and resolution corrections.
Authors: MUO POG
https://gitlab.cern.ch/cms-muonPOG/muonscarekit/-/blob/master/scripts/MuonScaRe.py?ref_type=heads
